  ...
  >
    ...
    >
      ...
      <h3 v-show="!isCollapse">
        <i class="iconfont icon-bianhuajiance" />手动选择图像
      </h3>
    </el-menu-item>
    ...
    >
      ...
      />
      <h3 v-show="!isCollapse">
        <i class="iconfont icon-mubiaojiance" />自动监测文件夹
      </h3>
    </el-menu-item>
    ...
    >
      ...
      />
      <h3 v-show="!isCollapse">
        <i class="iconfont icon-erfenleibianhuajiance16px" />手动设置阈值
      </h3>
    </el-menu-item>
    ...
    >
      ...
      />
      <h3 v-show="!isCollapse">
        <i class="iconfont icon-changjingguanli" />变化等级查询
      </h3>
    </el-menu-item>
    ...
    >
      ...
      />
      <h3 v-show="!isCollapse">
        <i class="iconfont icon-changjingguanli" />短信发件人
      </h3>
    </el-menu-item>

    <el-menu-item
      index="/classification2"
      @click="goClassification2"
    >
      <i
        v-show="isCollapse"
        class="iconfont icon-changjingguanli"
      />
      <h3 v-show="!isCollapse">
        <i class="iconfont icon-changjingguanli" />邮件发送人
      </h3>
    </el-menu-item>
    ...
    >
      ...
      />
      <h3 v-show="!isCollapse">
        <i class="iconfont icon-zaixianditu" />变化信息发布
      </h3>
    </el-menu-item>
    ...
    >
      ...
      />
      <h3 v-show="!isCollapse">
        <i class="iconfont icon-history" />变化信息汇总
      </h3>
    </el-menu-item>
