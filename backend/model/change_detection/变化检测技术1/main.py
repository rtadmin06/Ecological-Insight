...
def main(args):
    ...
    #net.load_state_dict(torch.load('./ckps/USSFCNet_LEVIRCD/USSFCNet_LEVIRCD_batch=32_lr=0.0001_epoch149model.pth', map_location='cuda:0'))
    
    #net.load_state_dict(torch.load('./no-weight-cdd/ckps/USSFCNet_LEVIRCD/USSFCNet_LEVIRCD_batch=64_lr=0.0001_epoch196model.pth', map_location='cuda:0'))
    # networks.load_state_dict(torch.load('/zyn/USSFC-Net-main/no-weight-cdd/ckps/USSFCNet_LEVIRCD//zyn/USSFC-Net-main/no-weight-cdd/ckps/USSFCNet_LEVIRCD', map_location='cuda:0'))
