...
from modules.fremix import _FrequencyMix
...
class USSFCNet(nn.Module):
    def __init__(self, in_ch, out_ch, ratio=0.5):
        ...
        self.fremix5 = _FrequencyMix(256)
        self.fremix4 = _FrequencyMix(128)
        self.fremix3 = _FrequencyMix(64)
        self.fremix2 = _FrequencyMix(32)
