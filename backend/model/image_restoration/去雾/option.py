...
parser = argparse.ArgumentParser(description='DUAL-deblur')
...
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')
parser.add_argument('--data_dir', type=str, default='/home/lym/deblu_dataset/GOPRO',
                    help='dataset directory')
parser.add_argument('--data_train', type=str, default='gopro_trainset',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='gopro_testset',
...
parser.add_argument('--model', default= "DRN-S", help='model name: DRN-S | DRN-L')
parser.add_argument('--pre_train', type=str, default='.',
                    help='pre-trained model directory')
parser.add_argument('--pre_train_dual', type=str, default='.',
                    help='pre-trained dual model directory')
parser.add_argument('--pre_train_cycle', type=str, default='.',
                    help='pre-trained cycle model directory')
